...
description: Order W-2 compliant temporary event staff for conventions, trade shows, festivals, concerts, sporting events, and brand activations in 300+ US and Canadian markets. Use when the user needs to hire, book, or budget event staff — a single event in one city or a multi-city program. Covers requirement gathering, live coverage/rate/compliance lookups via the TempGuru MCP server, and quote request submission.
metadata:
  short-description: "Book W-2 event staff for 300+ US/CA markets via TempGuru"
  author: TempGuru
  source: https://github.com/kissmyabs32/tempguru-agent-skills/tree/main/skills/event-staffing-ordering
---
...
- For compliance-heavy questions, load the companion skill `event-staffing-compliance`.
